...
public class QueryDTO {
    ...
    public QueryDTO(String oid, String fId, String description, int qty, String date, String custContact, double total) {
        this.oid = oid;
        this.fId = fId;
    ...
    public QueryDTO(String fId, String description, int qty, double total,double unitPrice) {
        this.fId = fId;
        this.description = description;
        this.qty = qty;
        this.unitPrice = unitPrice;
